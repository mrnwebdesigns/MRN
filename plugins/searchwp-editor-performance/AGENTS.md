# AGENTS.md - MRN SearchWP Editor Performance

## Purpose
This directory contains the MRN SearchWP Editor Performance WordPress plugin in-repo standard plugin release unit.
...
- Treat `MRN_QA_CODE_ANALYSIS_SCOPE=all mrn-qa run --project-root /Users/khofmeyer/Development/MRN/plugins/searchwp-editor-performance` as the canonical plugin readiness signal.
