# AGENTS.md - MRN Google Fonts

## Purpose
This directory contains the MRN Google Fonts WordPress plugin in-repo standard plugin release unit.
...
- Treat `MRN_QA_CODE_ANALYSIS_SCOPE=all mrn-qa run --project-root /Users/khofmeyer/Development/MRN/plugins/mrn-google-fonts` as the canonical plugin readiness signal.
