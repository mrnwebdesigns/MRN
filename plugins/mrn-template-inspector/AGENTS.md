# AGENTS.md - MRN Template Inspector

## Purpose
This directory contains the MRN Template Inspector WordPress plugin in-repo standard plugin release unit.
...
- Treat `MRN_QA_CODE_ANALYSIS_SCOPE=all mrn-qa run --project-root /Users/khofmeyer/Development/MRN/plugins/mrn-template-inspector` as the canonical plugin readiness signal.
