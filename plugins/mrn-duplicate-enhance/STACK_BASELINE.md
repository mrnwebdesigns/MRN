...
- Plugin source path: `/Users/khofmeyer/Development/MRN/plugins/mrn-duplicate-enhance`
- Current plugin version: `1.1.1`
- Intended integration target: optional plugin catalog
- Current release model: optional standard plugin release unit
...
2. Run `MRN_QA_CODE_ANALYSIS_SCOPE=all mrn-qa run --project-root /Users/khofmeyer/Development/MRN/plugins/mrn-duplicate-enhance`.
