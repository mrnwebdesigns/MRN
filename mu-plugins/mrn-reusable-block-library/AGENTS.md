...
## Purpose
This directory contains the MRN Reusable Block Library WordPress plugin shared MU plugin release unit.
...
- Treat `MRN_QA_CODE_ANALYSIS_SCOPE=all mrn-qa run --project-root /Users/khofmeyer/Development/MRN/mu-plugins/mrn-reusable-block-library` as the canonical plugin readiness signal.
