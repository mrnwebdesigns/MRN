# AGENTS.md - MRN Editor Lockdown

## Purpose
This directory contains the MRN Editor Lockdown WordPress plugin shared MU plugin release unit.
...
- Treat `MRN_QA_CODE_ANALYSIS_SCOPE=all mrn-qa run --project-root /Users/khofmeyer/Development/MRN/mu-plugins/mrn-editor-lockdown` as the canonical plugin readiness signal.
