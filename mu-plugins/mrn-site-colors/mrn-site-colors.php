...
function mrn_site_styles_load_sticky_toolbar_helper(): bool {
    ...
    // Explicit allow-list include paths only.
    if (defined('WP_CONTENT_DIR')) {
        $shared_path = WP_CONTENT_DIR . '/shared/mrn-sticky-settings-toolbar.php';
    ...
    $stack_shared_path = dirname(__DIR__, 2) . '/shared/mrn-sticky-settings-toolbar.php';
    if (file_exists($stack_shared_path)) {
