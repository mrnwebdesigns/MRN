# AGENTS.md - MRN Site Styles

## Purpose
This directory contains the MRN Site Styles WordPress plugin shared MU plugin release unit.
...
- Treat `MRN_QA_CODE_ANALYSIS_SCOPE=all mrn-qa run --project-root /Users/khofmeyer/Development/MRN/mu-plugins/mrn-site-colors` as the canonical plugin readiness signal.
