# AGENTS.md - MRN Active Style Guide

## Purpose
This directory contains the MRN Active Style Guide WordPress plugin shared MU plugin release unit.
...
- Treat `MRN_QA_CODE_ANALYSIS_SCOPE=all mrn-qa run --project-root /Users/khofmeyer/Development/MRN/mu-plugins/mrn-active-style-guide` as the canonical plugin readiness signal.
