# AGENTS.md - MRN Disable Comments

## Purpose
This directory contains the MRN Disable Comments WordPress plugin shared MU plugin release unit.
...
- Treat `MRN_QA_CODE_ANALYSIS_SCOPE=all mrn-qa run --project-root /Users/khofmeyer/Development/MRN/mu-plugins/mrn-disable-comments` as the canonical plugin readiness signal.
