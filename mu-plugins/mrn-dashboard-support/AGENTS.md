# AGENTS.md - MRN Dashboard Support

## Purpose
This directory contains the MRN Dashboard Support WordPress plugin shared MU plugin release unit.
...
- Treat `MRN_QA_CODE_ANALYSIS_SCOPE=all mrn-qa run --project-root /Users/khofmeyer/Development/MRN/mu-plugins/mrn-dashboard-support` as the canonical plugin readiness signal.
