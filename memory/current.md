...
- `mrn-dummy-content` is now a standalone stack-aware plugin with canonical source at `/Users/khofmeyer/Development/MRN-plugins/mrn-dummy-content`; `/Users/khofmeyer/Development/MRN/plugins/mrn-dummy-content` remains a compatibility symlink, release artifact path is `/Users/khofmeyer/Development/MRN/releases/plugins/mrn-dummy-content.zip`, and the stack manifest entry remains `/home/mrndev-stack-manager/stack/packages/mrn-dummy-content.zip`.
