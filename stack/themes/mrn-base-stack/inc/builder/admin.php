...
function mrn_base_stack_admin_enqueue_builder_assets( $hook_suffix ) {
	...
	wp_localize_script(
		...
		array(
			...
			'contentListLinkSupport'         => mrn_base_stack_get_content_list_link_support_map(),
			'contentListNoTaxonomiesText'    => __( 'This content source has no eligible filter taxonomies. Choose No Filter or specific content.', 'mrn-base-stack' ),
			'contentOnlySourceText'          => __( 'Content Only: these items are displayed inside other pages. They have no standalone page or archive. This does not prevent supported file downloads.', 'mrn-base-stack' ),
			'publicContentSourceText'        => __( 'Public content: item links use the available page or supported destination. Turning links off here only affects this row.', 'mrn-base-stack' ),
			'contentOnlyLinksDisabledText'   => __( 'Unavailable: this source has no supported item destinations. Items appear as content without links.', 'mrn-base-stack' ),
			'contentOnlyLinksOnText'         => __( 'On: items link to their supported file or custom destination. This does not create standalone pages. Items without a destination remain unlinked.', 'mrn-base-stack' ),
			'publicContentLinksOnText'       => __( 'On: items with a destination are clickable.', 'mrn-base-stack' ),
			'contentListLinksOffText'        => __( 'Off: items are displayed without links in this row. Their files and content are kept, and other rows are unchanged.', 'mrn-base-stack' ),
