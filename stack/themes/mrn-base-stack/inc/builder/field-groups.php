						...
						'layouts'           => array(
							'layout_mrn_hero' => array(
								...
								'sub_fields' => array(
									...
									...mrn_rbl_get_content_link_fields( 'field_mrn_hero_links', 'Links', 'links', 2 ),
									array(
						...
						'layouts'           => array(
								...
								'sub_fields' => array(
									...
									array(
										...
										'collapsed'    => 'field_mrn_slider_item_heading',
											...
											'sub_fields'   => array(
												array(
													'key'       => 'field_mrn_slider_item_content_tab',
													'label'     => 'Content',
													'name'      => '',
													'aria-label' => '',
													'type'      => 'tab',
											...
											array(
												...
												array(
													'key'       => 'field_mrn_slider_item_config_tab',
													'label'     => 'Configs',
													'name'      => '',
													'aria-label' => '',
													'type'      => 'tab',
												...
												array(
													'key'          => 'field_mrn_slider_item_background_color',
													'label'        => 'Background Color',
													'name'         => 'background_color',
													'aria-label'   => '',
													'type'         => 'select',
												...
												array(
													'key'           => 'field_mrn_slider_item_enable_row_effects',
							...
							'layout_mrn_tabbed_layout' => array(
								...
								'sub_fields' => array(
									...
									array(
										...
										array(
											'key'           => 'field_mrn_tabbed_layout_background_color',
											'label'         => 'Background Color',
											'name'          => 'background_color',
											'aria-label'    => '',
											'type'          => 'select',
							...
							'layout_mrn_image_content' => array(
								...
								'sub_fields' => array(
									...
									...mrn_rbl_get_content_link_fields( 'field_mrn_image_content_links', 'Links', 'links', 1 ),
									array(
							...
							'layout_mrn_card' => array(
								...
								'sub_fields' => array(
									...
									...mrn_rbl_get_content_link_fields( 'field_mrn_card_links', 'Links', 'links', 1 ),
									array(
										...
										'collapsed'    => 'field_mrn_card_item_text',
											...
											array(
												...
												array(
													'key'          => 'field_mrn_card_item_background_color',
													'label'        => 'Background Color',
													'name'         => 'background_color',
													'aria-label'   => '',
													'type'         => 'select',
							...
							'layout_mrn_stats' => array(
								...
								'sub_fields' => array(
									...
									array(
										...
										'min'          => 1,
										'sub_fields'   => array(
											...mrn_base_stack_get_button_link_icon_fields( 'field_mrn_stats_item_icon', 'field_mrn_stats_item_value' ),
											array(
								...
								'sub_fields' => array(
									...
									array(
										...
										'collapsed'    => 'field_mrn_showcase_item_link',
											...
											'sub_fields'   => array(
												array(
													'key'       => 'field_mrn_showcase_item_content_tab',
													'label'     => 'Content',
													'name'      => '',
													'aria-label' => '',
													'type'      => 'tab',
												...
												array(
													'key'       => 'field_mrn_showcase_item_config_tab',
													'label'     => 'Configs',
													'name'      => '',
													'aria-label' => '',
													'type'      => 'tab',
												...
												array(
													'key'          => 'field_mrn_showcase_item_background_color',
													'label'        => 'Background Color',
													'name'         => 'background_color',
													'aria-label'   => '',
													'type'         => 'select',
												...
												array(
													'key'           => 'field_mrn_showcase_item_enable_row_effects',
													'label'         => 'Enable Row Effects',
													'name'          => 'enable_row_effects',
													'aria-label'    => '',
													'type'          => 'true_false',
									...
									...mrn_rbl_get_content_link_fields( 'field_mrn_showcase_links', 'Links', 'links', 1 ),
									array(
