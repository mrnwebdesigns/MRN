						...
						'layouts'           => array(
							...
							'layout_mrn_external_widget' => array(
								...
								'sub_fields' => array(
									...
									mrn_base_stack_get_inline_text_field( 'field_mrn_external_widget_label', 'Label', 'label' ),
									mrn_base_stack_get_label_tag_field( 'field_mrn_external_widget_label_tag' ),
									mrn_base_stack_get_inline_text_field( 'field_mrn_external_widget_heading', 'Heading', 'heading' ),
									mrn_base_stack_get_text_tag_field( 'field_mrn_external_widget_heading_tag', 'heading_tag', 'h2', 'Heading Tag' ),
									mrn_base_stack_get_inline_text_field( 'field_mrn_external_widget_subheading', 'Subheading', 'subheading' ),
									mrn_base_stack_get_text_tag_field( 'field_mrn_external_widget_subheading_tag', 'subheading_tag', 'p', 'Subheading Tag' ),
									array(
										'key'           => 'field_mrn_external_widget_intro',
										'label'         => 'Text area with editor',
										'name'          => 'intro',
										'aria-label'    => '',
										'type'          => 'wysiwyg',
