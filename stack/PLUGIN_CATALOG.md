...
| `mrn-schema-bridge` | 0.4.6 | MU loader | Platform required | SEOPress identity linking and author policy, MRN supplemental schema, and migration-only SmartCrawl compatibility. |
