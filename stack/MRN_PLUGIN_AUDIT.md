...
| `mrn-mega-menu` | MRN Mega Menu | 0.16.16 | <https://github.com/mrnwebdesigns/MRN> | Stack-owned standard plugin; WooCommerce and shared stack integrations are optional and standalone-safe. |
