...
| `mrn-schema-bridge` | MRN Schema Bridge | 0.4.6 | <https://github.com/mrnwebdesigns/mrn-schema-bridge> | SEOPress is the preferred base graph; the bridge preserves canonical organization identity, author privacy, and legacy SmartCrawl compatibility. |
...
- `stack/mu-plugins/mrn-schema-bridge.php` is synced to `MRN Schema Bridge 0.4.6`.
