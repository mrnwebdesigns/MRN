...
## Current Release
- Stack release: `2026.08.24-mainwp-canary-protection`
...
- Standard plugins:
  ...
  - `mrn-stack-deployment-agent` `0.1.4`
...
- This release adds checksum-bound site/cohort policies for guarded MU component exclusions and required protected replacements, while retaining strict mutation allowlists.
- The Dashboard-only `mrn-mainwp-operations-api` `0.7.3` controller remains an independently released MainWP control-plane component and is not installed on child sites.
