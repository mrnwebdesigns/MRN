...
## Current Release
- Stack release: `2026.08.24-agent-recovery-evidence`
...
- Standard plugins:
  ...
  - `mrn-stack-deployment-agent` `0.1.5`
...
- This release adds bounded, sanitized, read-only evidence for incomplete deployment rollouts so recovery state can be classified before any mutation is authorized.
