...
| WordPress API runtime smoke | Skipped | Pass | /Users/khofmeyer/Development/MRN-task-worktrees/mrn-tokens-required-fleet | not applicable: no API runtime trigger detected |
| git diff --check | Ran | Pass | /Users/khofmeyer/Development/MRN-task-worktrees/mrn-tokens-required-fleet | no whitespace errors |
| Readme/version consistency | Skipped | Pass | /Users/khofmeyer/Development/MRN-task-worktrees/mrn-tokens-required-fleet | not applicable: MRN_QA_RUN_README_VERSION=auto only runs in release mode (--mode release) |
